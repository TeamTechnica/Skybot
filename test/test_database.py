...
test_flight1 = Flight(flight_num = "della1", airport='JFK',
                      flight_date = 10312018, departure_time=123000)
test_flight2 = Flight(flight_num = "della2", airport = 'JFK',
                      flight_date = 10312018, departure_time = 123000)
test_flight3 = Flight(flight_num = "della3", airport = 'LGA',
                      flight_date = 12252018, departure_time = 124500)
test_flight4 = Flight(flight_num = "della5", airport = 'LGA',
                      flight_date = 12252018, departure_time = 100000)
test_flight5 = Flight(flight_num = "della6", airport = 'LGA',
                      flight_date = 12252018, departure_time = 100000)
...
# Query flight times and airports based on date
    ...
    def test_ReturnFlightInfo(self):
        ...
        for i in range (0,len(matching_flights)):
            flight_info.append((matching_flights[i].airport,
...
# Deletes test cases from database
    def test_Delete(self):
        ...
        self.assertEqual(results, "[<Flight 1>, <Flight 2>,
                            <Flight 4>, <Flight 5>]")
